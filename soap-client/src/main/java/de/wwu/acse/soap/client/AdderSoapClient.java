...
public class AdderSoapClient extends WebServiceGatewaySupport {
	private final String adderWebServiceUri;
	
	@Autowired
	public AdderSoapClient(@Value("${adderws.uri}") String uri) {
		this.adderWebServiceUri = uri;
		...
		this.setDefaultUri(adderWebServiceUri);
